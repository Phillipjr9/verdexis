...
export default function WithdrawalResult({
  ...
  return (
    <Modal open={true} onClose={() => onClose(id)} title={success ? 'Withdrawal Sent' : 'Withdrawal Failed'}>
      <div className="space-y-3">
        {success ? (
          <>
            <div className="text-sm text-[#E5E5E5]">Your withdrawal transaction was submitted.</div>
            {txHash && (
              <div>
          ...
          <>
            <div className="text-sm text-[#E5E5E5]">There was a problem submitting the withdrawal.</div>
