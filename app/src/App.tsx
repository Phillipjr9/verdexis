...
const AdminWithdrawalQueue = withLazyErrorBoundary(() => import('./pages/AdminWithdrawalQueue'), 'Admin Withdrawal Queue')
  ...
  return (
    <div className="page-fade-in">
      ...
      <Routes location={location}>
          ...
          <Route path="/admin/withdrawals" element={<RequireAdmin><AdminWithdrawalQueue /></RequireAdmin>} />
          ...
          <Route path="/copy-trading/trader/:userId" element={<RequireAuth><TraderDetail /></RequireAuth>} />
